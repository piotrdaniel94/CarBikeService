...
public class ServiceLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_forgotPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ServiceLogin.this, ServiceResetPasswordActivity.class));
            }
        });
        ...
        tv_registerBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ServiceLogin.this, ServiceRegister.class));
            }
        });
            ...
            mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(ServiceLogin.this, "Login Failed", Toast.LENGTH_SHORT).show();
                    }
                }
            });
    ...
    private void sendUserToMainActivity() {
        Intent intent = new Intent(ServiceLogin.this, ServiceDashboard.class);
